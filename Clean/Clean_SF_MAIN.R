...
df_demographique=read.csv("D:\\ISAE-2021\\2021_05_19_RawData_tRNS_study.csv",head=TRUE,dec = ",",sep=";")
data_long=demographie_long(final_df,df_demographique)
data_wide=demographie(final_df ,df_demographique,FALSE)
