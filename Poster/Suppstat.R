...
data_long = data_long%>%
  filter(Group!="STIMSD")
#FORTRESS
p_destroyed_fortress = ggplot(filter(data_long,Session=="D01P1"|Session=="D05P2"|Session=="D14P2"),aes(Group,DestroyedFortress,color=Group))+theme_pubr()+
...
p_S11S9_Fortress=ggplot(data_wide,aes(Group,DeltaD14D5Fortress,color=Group,fill=Group,shape=Group))+
  ...
  stat_summary(fun.data = "mean_se", fun.args = list(mult = 1),size=1 ,show.legend = FALSE,geom="errorbar",width=0.1)+
  stat_summary(fun=mean, geom="point",size=4)+
  ylab("Delta Performance (Retention) Fortress")+
  ...
  add_pvalue(ph_S11S9_Fortress[1,],y.position=7500,
             label = "p = {round(p.adj,3)} ", inherit.aes = FALSE,label.size=5)+
  add_pvalue(ph_S11S9_Fortress[2,],y.position=9500,
             label = "p = {round(p.adj,3)}", inherit.aes = FALSE,label.size=5,fontface="bold")+
  add_pvalue(ph_S11S9_Fortress[3,],y.position=8500,
             label = "p = {round(p.adj,3)}", inherit.aes = FALSE,label.size=5,fontface="bold")+
  annotation_custom(grob_S11S9_Fortress)+
...
p_S11S9_Flight=ggplot(data_wide,aes(Group,DeltaD14D5Flight,color=Group,fill=Group,shape=Group))+
  ...
  stat_summary(fun.data = "mean_se", fun.args = list(mult = 1),size=1 ,show.legend = FALSE,geom="errorbar",width=0.1)+
  stat_summary(fun=mean, geom="point",size=4)+
  ylab("Delta Performance (Retention) Flight")+
  rremove("legend")+scale_x_discrete(labels=c("Sham","SD-tRNS","HD-tRNS"))+
  scale_y_continuous( breaks=seq(-4000,10000,2000),limits=c(-4000,12000))+
  add_pvalue(ph_S11S9_Flight[1,],y.position=7500,
             label = "p = {round(p.adj,3)} ", inherit.aes = FALSE,label.size=5)+
  add_pvalue(ph_S11S9_Flight[2,],y.position=9500,
             label = "p = {round(p.adj,3)}", inherit.aes = FALSE,label.size=5,fontface="bold")+
  add_pvalue(ph_S11S9_Flight[3,],y.position=8500,
             label = "p = {round(p.adj,3)}", inherit.aes = FALSE,label.size=5,fontface="bold")+
  annotation_custom(grob_S11S9_Flight)+
  theme(axis.title=element_text(size=18,margin=0.1),text =element_text(size=16) )
p_S11S9_Flight  
...
p_S11S9_Bonus=ggplot(data_wide,aes(Group,DeltaD14D5Bonus,color=Group,fill=Group,shape=Group))+
  ...
  stat_summary(fun.data = "mean_se", fun.args = list(mult = 1),size=1 ,show.legend = FALSE,geom="errorbar",width=0.1)+
  stat_summary(fun=mean, geom="point",size=4)+
  ylab("Delta Performance (Retention) Bonus")+
  rremove("legend")+scale_x_discrete(labels=c("Sham","SD-tRNS","HD-tRNS"))+
  scale_y_continuous( breaks=seq(-4000,10000,2000),limits=c(-4000,12000))+
  add_pvalue(ph_S11S9_Bonus[1,],y.position=7500,
             label = "p = {round(p.adj,3)} ", inherit.aes = FALSE,label.size=5)+
  add_pvalue(ph_S11S9_Bonus[2,],y.position=9500,
             label = "p = {round(p.adj,3)}", inherit.aes = FALSE,label.size=5,fontface="bold")+
  add_pvalue(ph_S11S9_Bonus[3,],y.position=8500,
             label = "p = {round(p.adj,3)}", inherit.aes = FALSE,label.size=5,fontface="bold")+
  annotation_custom(grob_S11S9_Bonus)+
  theme(axis.title=element_text(size=18,margin=0.1),text =element_text(size=16) )
p_S11S9_Bonus  
...
p_S11S9_Mine=ggplot(data_wide,aes(Group,DeltaD14D5Mine,color=Group,fill=Group,shape=Group))+
  ...
  stat_summary(fun.data = "mean_se", fun.args = list(mult = 1),size=1 ,show.legend = FALSE,geom="errorbar",width=0.1)+
  stat_summary(fun=mean, geom="point",size=4)+
  ylab("Delta Performance (Retention) Mine")+
  rremove("legend")+scale_x_discrete(labels=c("Sham","SD-tRNS","HD-tRNS"))+
  scale_y_continuous( breaks=seq(-4000,10000,2000),limits=c(-4000,12000))+
  add_pvalue(ph_S11S9_Mine[1,],y.position=7500,
             label = "p = {round(p.adj,3)} ", inherit.aes = FALSE,label.size=5)+
  add_pvalue(ph_S11S9_Mine[2,],y.position=9500,
             label = "p = {round(p.adj,3)}", inherit.aes = FALSE,label.size=5,fontface="bold")+
  add_pvalue(ph_S11S9_Mine[3,],y.position=8500,
             label = "p = {round(p.adj,3)}", inherit.aes = FALSE,label.size=5,fontface="bold")+
  annotation_custom(grob_S11S9_Mine)+
  theme(axis.title=element_text(size=18,margin=0.1),text =element_text(size=16) )
p_S11S9_Mine  
...
p_S11S1_Fortress=ggplot(data_wide,aes(Group,DeltaD1D14Fortress,color=Group,fill=Group,shape=Group))+
  ...
  stat_summary(fun.data = "mean_se", fun.args = list(mult = 1),size=1 ,show.legend = FALSE,geom="errorbar",width=0.1)+
  stat_summary(fun=mean, geom="point",size=4)+
  ylab("Delta Performance (LongTerm) Fortress")+
  rremove("legend")+scale_x_discrete(labels=c("Sham","SD-tRNS","HD-tRNS"))+
  scale_y_continuous( breaks=seq(0,15000,2000),limits=c(0,18000))+
  add_pvalue(ph_S11S1_Fortress[1,],y.position=14000,
             label = "p = {round(p.adj,3)} ", inherit.aes = FALSE,label.size=5)+
  add_pvalue(ph_S11S1_Fortress[2,],y.position=16000,
             label = "p = {round(p.adj,3)}", inherit.aes = FALSE,label.size=5,fontface="bold")+
  add_pvalue(ph_S11S1_Fortress[3,],y.position=15000,
             label = "p = {round(p.adj,3)}", inherit.aes = FALSE,label.size=5,fontface="bold")+
  annotation_custom(grob_S11S1_Fortress)+
  theme(axis.title=element_text(size=18,margin=0.1),text =element_text(size=16) )
p_S11S1_Fortress  
...
p_S11S1_Flight=ggplot(data_wide,aes(Group,DeltaD1D14Flight,color=Group,fill=Group,shape=Group))+
  ...
  rremove("legend")+scale_x_discrete(labels=c("Sham","SD-tRNS","HD-tRNS"))+
  scale_y_continuous( breaks=seq(-4000,10000,2000),limits=c(-4000,12000))+
  add_pvalue(ph_S11S1_Flight[1,],y.position=7500,
             label = "p = {round(p.adj,3)} ", inherit.aes = FALSE,label.size=5)+
  add_pvalue(ph_S11S1_Flight[2,],y.position=9500,
             label = "p = {round(p.adj,3)}", inherit.aes = FALSE,label.size=5,fontface="bold")+
  add_pvalue(ph_S11S1_Flight[3,],y.position=8500,
             label = "p = {round(p.adj,3)}", inherit.aes = FALSE,label.size=5,fontface="bold")+
  annotation_custom(grob_S11S1_Flight)+
  theme(axis.title=element_text(size=18,margin=0.1),text =element_text(size=16) )
p_S11S1_Flight  
...
p_S11S1_Bonus=ggplot(data_wide,aes(Group,DeltaD1D14Bonus,color=Group,fill=Group,shape=Group))+
  ...
  rremove("legend")+scale_x_discrete(labels=c("Sham","SD-tRNS","HD-tRNS"))+
  scale_y_continuous( breaks=seq(-4000,10000,2000),limits=c(-4000,12000))+
  add_pvalue(ph_S11S1_Bonus[1,],y.position=7500,
             label = "p = {round(p.adj,3)} ", inherit.aes = FALSE,label.size=5)+
  add_pvalue(ph_S11S1_Bonus[2,],y.position=9500,
             label = "p = {round(p.adj,3)}", inherit.aes = FALSE,label.size=5,fontface="bold")+
  add_pvalue(ph_S11S1_Bonus[3,],y.position=8500,
             label = "p = {round(p.adj,3)}", inherit.aes = FALSE,label.size=5,fontface="bold")+
  annotation_custom(grob_S11S1_Bonus)+
  theme(axis.title=element_text(size=18,margin=0.1),text =element_text(size=16) )
p_S11S1_Bonus  
...
p_S11S1_Mine=ggplot(data_wide,aes(Group,DeltaD1D14Mine,color=Group,fill=Group,shape=Group))+
  ...
  rremove("legend")+scale_x_discrete(labels=c("Sham","SD-tRNS","HD-tRNS"))+
  scale_y_continuous( breaks=seq(-4000,10000,2000),limits=c(-4000,12000))+
  add_pvalue(ph_S11S1_Mine[1,],y.position=7500,
             label = "p = {round(p.adj,3)} ", inherit.aes = FALSE,label.size=5)+
  add_pvalue(ph_S11S1_Mine[2,],y.position=9500,
             label = "p = {round(p.adj,3)}", inherit.aes = FALSE,label.size=5,fontface="bold")+
  add_pvalue(ph_S11S1_Mine[3,],y.position=8500,
             label = "p = {round(p.adj,3)}", inherit.aes = FALSE,label.size=5,fontface="bold")+
  annotation_custom(grob_S11S1_Mine)+
  theme(axis.title=element_text(size=18,margin=0.1),text =element_text(size=16) )
p_S11S1_Mine  
...
p_S9S1_Fortress=ggplot(data_wide,aes(Group,DeltaD5D1Fortress,color=Group,fill=Group,shape=Group))+
  ...
  add_pvalue(ph_S9S1_Fortress[1,],y.position=14000,
             label = "p = {round(p.adj,3)} ", inherit.aes = FALSE,label.size=5)+
  add_pvalue(ph_S9S1_Fortress[2,],y.position=16000,
             label = "p = {round(p.adj,3)}", inherit.aes = FALSE,label.size=5,fontface="bold")+
  add_pvalue(ph_S9S1_Fortress[3,],y.position=15000,
             label = "p = {round(p.adj,3)}", inherit.aes = FALSE,label.size=5,fontface="bold")+
  annotation_custom(grob_S9S1_Fortress)+
  theme(axis.title=element_text(size=18,margin=0.1),text =element_text(size=16) )
p_S9S1_Fortress  


###DELTA S11-S19 (short term) on Flight Score

ancova_S9S1_Flight=data_wide%>%
  anova_test(DeltaD1D5Flight~Group+GameLevelLog) #EFFET DU GROUP p = 0.018
ph_S9S1_Flight=data_wide%>%
  emmeans_test(DeltaD1D5Flight~Group,covariate = GameLevelLog,p.adjust.method = "holm")
...
p_S9S1_Flight=ggplot(data_wide,aes(Group,DeltaD1D5Flight,color=Group,fill=Group,shape=Group))+
  theme_pubr()+scale_fill_manual(values=couleurs_alpha)+
  scale_color_manual(values=couleurs)+
  geom_half_violin(width=0.3, position = position_nudge(x=-0.2,y=0))+geom_jitter(width=0.1)+
  stat_summary(fun.data = "mean_se", fun.args = list(mult = 1),size=1 ,show.legend = FALSE,geom="errorbar",width=0.1)+
  ...
  rremove("legend")+scale_x_discrete(labels=c("Sham","SD-tRNS","HD-tRNS"))+
  scale_y_continuous( breaks=seq(-4000,10000,2000),limits=c(-4000,12000))+
  add_pvalue(ph_S9S1_Flight[1,],y.position=7500,
             label = "p = {round(p.adj,3)} ", inherit.aes = FALSE,label.size=5)+
  add_pvalue(ph_S9S1_Flight[2,],y.position=9500,
             label = "p = {round(p.adj,3)}", inherit.aes = FALSE,label.size=5,fontface="bold")+
  add_pvalue(ph_S9S1_Flight[3,],y.position=8500,
             label = "p = {round(p.adj,3)}", inherit.aes = FALSE,label.size=5,fontface="bold")+
  annotation_custom(grob_S9S1_Flight)+
  theme(axis.title=element_text(size=18,margin=0.1),text =element_text(size=16) )
p_S9S1_Flight  


###DELTA S11-S19 (short term) on Bonus Score

ancova_S9S1_Bonus=data_wide%>%
  anova_test(DeltaD1D5Bonus~Group+GameLevelLog) #EFFET DU GROUP p = 0.018
ph_S9S1_Bonus=data_wide%>%
  emmeans_test(DeltaD1D5Bonus~Group,covariate = GameLevelLog,p.adjust.method = "holm")
...
p_S9S1_Bonus=ggplot(data_wide,aes(Group,DeltaD1D5Bonus,color=Group,fill=Group,shape=Group))+
  theme_pubr()+scale_fill_manual(values=couleurs_alpha)+
  scale_color_manual(values=couleurs)+
  geom_half_violin(width=0.3, position = position_nudge(x=-0.2,y=0))+geom_jitter(width=0.1)+
  stat_summary(fun.data = "mean_se", fun.args = list(mult = 1),size=1 ,show.legend = FALSE,geom="errorbar",width=0.1)+
  ...
  rremove("legend")+scale_x_discrete(labels=c("Sham","SD-tRNS","HD-tRNS"))+
  scale_y_continuous( breaks=seq(-4000,10000,2000),limits=c(-4000,12000))+
  add_pvalue(ph_S9S1_Bonus[1,],y.position=7500,
             label = "p = {round(p.adj,3)} ", inherit.aes = FALSE,label.size=5)+
  add_pvalue(ph_S9S1_Bonus[2,],y.position=9500,
             label = "p = {round(p.adj,3)}", inherit.aes = FALSE,label.size=5,fontface="bold")+
  add_pvalue(ph_S9S1_Bonus[3,],y.position=8500,
             label = "p = {round(p.adj,3)}", inherit.aes = FALSE,label.size=5,fontface="bold")+
  annotation_custom(grob_S9S1_Bonus)+
  theme(axis.title=element_text(size=18,margin=0.1),text =element_text(size=16) )
p_S9S1_Bonus  
...
ancova_S9S1_Mine=data_wide%>%
  anova_test(DeltaD1D5Mine~Group+GameLevelLog) #EFFET DU GROUP p = 0.018
ph_S9S1_Mine=data_wide%>%
  emmeans_test(DeltaD1D5Mine~Group,covariate = GameLevelLog,p.adjust.method = "holm")
...
p_S9S1_Mine=ggplot(data_wide,aes(Group,DeltaD1D5Mine,color=Group,fill=Group,shape=Group))+
  theme_pubr()+scale_fill_manual(values=couleurs_alpha)+
  scale_color_manual(values=couleurs)+
  geom_half_violin(width=0.3, position = position_nudge(x=-0.2,y=0))+geom_jitter(width=0.1)+
  stat_summary(fun.data = "mean_se", fun.args = list(mult = 1),size=1 ,show.legend = FALSE,geom="errorbar",width=0.1)+
  ...
  rremove("legend")+scale_x_discrete(labels=c("Sham","SD-tRNS","HD-tRNS"))+
  scale_y_continuous( breaks=seq(-4000,10000,2000),limits=c(-4000,12000))+
  add_pvalue(ph_S9S1_Mine[1,],y.position=7500,
             label = "p = {round(p.adj,3)} ", inherit.aes = FALSE,label.size=5)+
  add_pvalue(ph_S9S1_Mine[2,],y.position=9500,
             label = "p = {round(p.adj,3)}", inherit.aes = FALSE,label.size=5,fontface="bold")+
  add_pvalue(ph_S9S1_Mine[3,],y.position=8500,
             label = "p = {round(p.adj,3)}", inherit.aes = FALSE,label.size=5,fontface="bold")+
  annotation_custom(grob_S9S1_Mine)+
  theme(axis.title=element_text(size=18,margin=0.1),text =element_text(size=16) )
p_S9S1_Mine  
